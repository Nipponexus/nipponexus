...
## 開催情報・アクセス (6項目以上。開催時期・開催場所・アクセス・料金を必ず含む。料金は金額を断定せず『沿道は無料/有料観覧席あり』等の恒常的な構造を書き、変動する額は『料金は年により変動するため公式発表を参照』とする)
## 周辺情報 (3段落以上)
## 関連情報 (6項目以上)

【文章の質】各段落3文以上。各事実を3段展開(事実→背景/理由→意味/情景)。抽象語の水増し禁止。固有事実(年号・地名・人名・数値)で肉付け。

【ハルシネーション厳禁(最重要)】Webで確認できない事実は書かない。起源等が不確かなら「言い伝えによれば」「一説では」等の留保を付ける。創作で字数を埋めない。電話番号は公式で確認できた実番号のみ記載し、裏取り不能なら項目ごと省略する(『公式サイトで確認』等の但し書きも書かない)。不確かな数値は書かない。中止・休止のあった祭りは開催情報に「最新の開催日程・実施可否は公式サイトで確認」と明記。終了した祭りは過去形で歴史的事実として記述。
